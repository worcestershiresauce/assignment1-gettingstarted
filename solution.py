...
def welcome_assignment_answers(question):
    ...
    if question == "Are encoding and encryption the same? - Yes/No":
        ...
        answer = "Yes"
    elif question == "In Slack, what is secret passphrase posted in #lab-python-getting-started channel posted by TA?":
        answer = "mtls"
        ...
        answer = "No"
    elif question == "What layer from TCP/IP model does protocol DHCP belong to? - The answer should be numeric number":
        answer = "5"
    elif question == "What layer of TCP/IP model does protocol TCP belong to? - The answer should be a numeric number":
        answer = "4"
        return(answer)
